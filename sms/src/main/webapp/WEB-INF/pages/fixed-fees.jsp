...
<body>
	...
	<article>
		...
		<form:form class="mrg-top" id="new" action="processFixedFee">

			<ul>

				<li class="f">
					<h3 class="back">Fixed Fee Details</h3>
				</li>
				...
				<form:select
						...
						<c:forEach items="${batchList}" var="batch" varStatus="loop">
							...
							<c:choose>
							<c:when test="${batch==command.batchId}">
				...
				<li class="f">
					<div class="main-fees">
						...
						<div class="main-fees2">
							...
							<div class="main-fees-h1">Examination Fee</div>

							<div class="main-fees-h1">Maintanence Fee</div>

							<div class="main-fees-h1">Tution Fee</div>


							<div class="main-fees-h1">Report Card</div>

							<div class="main-fees-h1">Fee Book</div>
							<div class="main-fees-h1">I Card</div>

							<div class="main-fees-h1">Water And Elec Gene</div>
							...
							<div class="main-fees-h1">Sport & Cultural Fee</div>

							<div class="main-fees-h1">Library Fee</div>


							<div class="main-fees-h1">Activity Fee</div>
						...
						<div class="main-fees3">
							...
							<div>
								<form:input path="fixedFeeId" type="hidden" />
							</div>
							<div class="main-fees-h2">
								<form:input path="examinationFee" />
							...
							<div class="main-fees-h2">
								<form:input path="reportCardFee" />
							</div>


							<div class="main-fees-h2">
								<form:input path="bookFee" />
							</div>

							<div class="main-fees-h2">
								<form:input path="icardFee" />
							</div>


							<div class="main-fees-h2">
								<form:input path="waterElectricFee" />
							</div>
							...
							<div class="main-fees-h2">
								<form:input path="sportsCultureFee" />
							</div>

							<div class="main-fees-h2">
								<form:input path="libraryFee" />
							</div>

							<div class="main-fees-h2">
								<form:input path="activityFee" />
							</div>
