...
<head>
<meta charset="utf-8">
<title>List Department Master</title>
<link rel="StyleSheet"
...
<body>
	...
	<article>
		...
		<ul>
				...
				<li class="f">
					<h3 class="back">List Department Master</h3>
				</li>
		</ul>			
		...
		<table width="1224" border="1">
			<tr>
				<th width="96" scope="col"><u>
					<span class="style2">Department Id </span></u></th>
				<th width="95" scope="col"><u>
					<span class="style2">Department Name</span></u></th>
			</tr>
