...
<head>
<meta charset="utf-8">
<title>List Sent Messages</title>
<link rel="StyleSheet"
...
<body>
	...
	<article>
		...
		<ul>
				...
				<li class="f">
					<h3 class="back">List Sent Messages</h3>
				</li>
		</ul>			
		...
		<table width="1224" border="1">
			<tr>
				...
				<th width="95" scope="col"><u>
					<span class="style2">Date</span></u></th>
					<th width="95" scope="col"><u>
					<span class="style2">Message </span></u></th>
					
					
					
			</tr>
			<c:forEach var="sentMessage" items="${listSentMessages}">
				<tr>
					<td>${sentMessage.mobileNo}</td>
					<td>${sentMessage.date}</td>
					<td>${sentMessage.smsContent}</td>
