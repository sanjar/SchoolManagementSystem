...
<head>
<meta charset="utf-8">
<title>List Processed Salaries</title>
<link rel="StyleSheet"
...
<body>
	...
	<article>
		...
		<ul>
				...
				<li class="f">
					<h3 class="back">List Processed Salaries</h3>
				</li>
		</ul>			
		...
		<table width="1224" border="1">
			<tr>
				...
				<th width="95" scope="col"><u>
					<span class="style2">Year</span></u></th>
					<th width="95" scope="col"><u>
					<span class="style2">Month </span></u></th>
					<th width="95" scope="col"><u>
					<span class="style2">Salary Process Date</span></u></th>
					<th width="95" scope="col"><u>
			...
			<c:forEach var="processedSalary" items="${listProcessedSalaries}">
				<tr>
					<td>${processedSalary.salaryMaster.salaryId}</td>
					<td>${processedSalary.year}</td>
					<td>${processedSalary.month}</td>
					<td>${processedSalary.processingDate}</td>
					<td>${processedSalary.comments}</td>
