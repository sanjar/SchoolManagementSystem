...
<body>
	...
	<!-- ======== Main Content ======== -->
<div><h2> <span ><center>Purchase Receipt List</center></span></h2></div>	
<div id="sidebar1" >							
...
<table width="1224" border="1" id="report">
  <tr>
    <th width="95" scope="col"><u><span style="color: yellow">Receipt No</span></u></th>
    <th width="95" scope="col"><u><span style="color: yellow">Receipt Date</span></u></th>
    <th width="95" scope="col"><u><span style="color: yellow">Invoice No</span></u></th>
    <th width="76" scope="col"><u><span style="color: yellow">Company Name</span></u></th>
  ...
  <c:forEach var="purchaseReceipt" items="${purchaseReceipts}">
  <tr class="odd">
    <td>${purchaseReceipt.receiptNo}</td>
    <td>${purchaseReceipt.receiptDate}</td>
    <td>${purchaseReceipt.invoiceNo}</td>
    <td>${purchaseReceipt.company}</td>
    <td>${purchaseReceipt.grossValue}</td>
    <td>${purchaseReceipt.netValue}</td>
  ...
  <table id="inner">
  		<tr>
		    ...
		    <th width="95" scope="col"><u><span style="color: yellow">Purchase Price</span></u></th>
		    <th width="76" scope="col"><u><span style="color: yellow">Quantity Unit</span></u></th>
  ...
  <c:forEach var="purchaseReceiptItem" items="${purchaseReceipt.purchaseReceiptItemList}">
  <tr>
    <td>${purchaseReceiptItem.productCode}</td>
    <td>${purchaseReceiptItem.description}</td>
    <td>${purchaseReceiptItem.purchasePrice}</td>
    <td>${purchaseReceiptItem.quantityUnit}</td>
    <td>${purchaseReceiptItem.discount}</td>
    <td>${purchaseReceiptItem.totalAmount}</td>
